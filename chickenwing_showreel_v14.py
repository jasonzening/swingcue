...
TMP_AVI = PREVIEW / "cw001_v14_tmp.avi"
OUT_VID = PREVIEW / "cw001_v14_demo.mp4"
OUT_HTML= PREVIEW / "cw001_v14_demo.html"
...
def draw_guide_arrow(img, src, tgt, color=YELLOW, pulse=1.0):
    ...
    pts = np.array([ip(tip),
                    ip(notch + perp * hw),
                    ip(notch - perp * hw)], dtype=np.int32)

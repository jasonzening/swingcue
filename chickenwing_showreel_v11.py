...
TMP_AVI = PREVIEW / "cw001_v11_tmp.avi"
OUT_VID = PREVIEW / "cw001_v11_demo.mp4"
OUT_HTML= PREVIEW / "cw001_v11_demo.html"
...
# fi=150..158: flash衰减, 稳定绿线
FLASH_PEAK  = PH3_END - 1   # fi=149
FLASH_RISE  = 15             # flash 从 fi=134 开始上升 (领先颜色7帧)
FLASH_FALL  = 9              # fi=150..158 衰减
# full flash window: fi 134..158

# 颜色变化锁定在 fi=141..149 (8帧, 267ms, 在flash亮光中完成)
COLOR_START_FI = FLASH_PEAK - 8   # fi=141 (flash已亮47%时才开始变色)
COLOR_END_FI   = FLASH_PEAK       # fi=149 颜色100%绿

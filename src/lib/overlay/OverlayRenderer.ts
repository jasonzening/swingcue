/**
 * OverlayRenderer.ts ÃÂ¢ÃÂÃÂ ÃÂ¦ÃÂÃÂÃÂ¨ÃÂ½ÃÂ¬ÃÂ§ÃÂÃÂÃÂ¦ÃÂ¸ÃÂ²ÃÂ¦ÃÂÃÂÃÂ¥ÃÂÃÂ¨ÃÂ¯ÃÂ¼ÃÂÃÂ¦ÃÂ ÃÂ·ÃÂ¦ÃÂÃÂ¿ÃÂ¥ÃÂÃÂ¾1:1ÃÂ¥ÃÂ¤ÃÂÃÂ¥ÃÂÃÂ»ÃÂ¯ÃÂ¼ÃÂ
 *
 * drawEllipse ÃÂ¤ÃÂ¸ÃÂÃÂ¥ÃÂ±ÃÂÃÂ¦ÃÂ¸ÃÂ²ÃÂ¦ÃÂÃÂ + 3DÃÂ¥ÃÂÃÂÃÂ¥ÃÂÃÂÃÂ¥ÃÂ¼ÃÂ§ÃÂ¥ÃÂÃÂºÃÂ¥ÃÂÃÂÃÂ¯ÃÂ¼ÃÂ
 *   ÃÂ¥ÃÂÃÂÃÂ¥ÃÂ¼ÃÂ§ÃÂ¯ÃÂ¼ÃÂÃÂ¦ÃÂÃÂÃÂ©ÃÂÃÂÃÂ¥ÃÂ¤ÃÂ´ÃÂ¯ÃÂ¼ÃÂ= ÃÂ§ÃÂ²ÃÂÃÂ¥ÃÂ®ÃÂÃÂ§ÃÂºÃÂ¿ + ÃÂ¥ÃÂ¼ÃÂºÃÂ¥ÃÂÃÂÃÂ¥ÃÂÃÂ
 *   ÃÂ¥ÃÂÃÂÃÂ¥ÃÂ¼ÃÂ§ÃÂ¯ÃÂ¼ÃÂÃÂ¨ÃÂÃÂÃÂ©ÃÂÃÂÃÂ¥ÃÂ¤ÃÂ´ÃÂ¯ÃÂ¼ÃÂ= ÃÂ§ÃÂ»ÃÂÃÂ¨ÃÂÃÂÃÂ§ÃÂºÃÂ¿ + ÃÂ¦ÃÂ·ÃÂ¡ÃÂ¯ÃÂ¼ÃÂÃÂ¦ÃÂ¨ÃÂ¡ÃÂ¦ÃÂÃÂÃÂ¨ÃÂ¢ÃÂ«ÃÂ¨ÃÂºÃÂ«ÃÂ¤ÃÂ½ÃÂÃÂ©ÃÂÃÂ®ÃÂ¦ÃÂÃÂ¡ÃÂ¯ÃÂ¼ÃÂ
...
/**
 * drawEllipse ÃÂ¢ÃÂÃÂ 3DÃÂ¦ÃÂÃÂÃÂ¨ÃÂ½ÃÂ¬ÃÂ§ÃÂÃÂÃÂ¯ÃÂ¼ÃÂÃÂ¤ÃÂ¸ÃÂÃÂ¦ÃÂ¯ÃÂÃÂ¤ÃÂ¸ÃÂÃÂ¥ÃÂ¯ÃÂ¹ÃÂ¦ÃÂ ÃÂÃÂ¦ÃÂ ÃÂ·ÃÂ¦ÃÂÃÂ¿ÃÂ¥ÃÂÃÂ¾ÃÂ¯ÃÂ¼ÃÂ
 *
 * ÃÂ¥ÃÂÃÂÃÂ¥ÃÂ¼ÃÂ§ = ÃÂ¦ÃÂÃÂÃÂ¥ÃÂÃÂÃÂ©ÃÂÃÂÃÂ¥ÃÂ¤ÃÂ´ÃÂ§ÃÂÃÂÃÂ¥ÃÂÃÂÃÂ¥ÃÂ¼ÃÂ§ÃÂ¯ÃÂ¼ÃÂÃÂ§ÃÂ²ÃÂ + ÃÂ¥ÃÂ¼ÃÂºÃÂ¥ÃÂÃÂÃÂ¥ÃÂÃÂÃÂ¯ÃÂ¼ÃÂ
 * ÃÂ¥ÃÂÃÂÃÂ¥ÃÂ¼ÃÂ§ = ÃÂ¨ÃÂÃÂÃÂ¥ÃÂÃÂÃÂ©ÃÂÃÂÃÂ¥ÃÂ¤ÃÂ´ÃÂ§ÃÂÃÂÃÂ¥ÃÂÃÂÃÂ¥ÃÂ¼ÃÂ§ÃÂ¯ÃÂ¼ÃÂÃÂ§ÃÂ»ÃÂÃÂ¨ÃÂÃÂÃÂ§ÃÂºÃÂ¿ + ÃÂ¦ÃÂ·ÃÂ¡ÃÂ¯ÃÂ¼ÃÂÃÂ¦ÃÂ¨ÃÂ¡ÃÂ¦ÃÂÃÂÃÂ¨ÃÂ¢ÃÂ«ÃÂ¨ÃÂºÃÂ«ÃÂ¤ÃÂ½ÃÂÃÂ©ÃÂÃÂ®ÃÂ¦ÃÂÃÂ¡ÃÂ¯ÃÂ¼ÃÂ
 * ÃÂ¥ÃÂ¡ÃÂ«ÃÂ¥ÃÂÃÂ = ÃÂ¦ÃÂÃÂ´ÃÂ§ÃÂÃÂÃÂ¥ÃÂÃÂÃÂ©ÃÂÃÂÃÂ¦ÃÂÃÂ
 *
 * face_on ÃÂ¨ÃÂ§ÃÂÃÂ¨ÃÂ§ÃÂÃÂ¯ÃÂ¼ÃÂ
 *   ÃÂ¥ÃÂÃÂÃÂ¥ÃÂ¼ÃÂ§ = ellipse ÃÂ¤ÃÂ¸ÃÂÃÂ¥ÃÂÃÂÃÂ¥ÃÂÃÂÃÂ¯ÃÂ¼ÃÂy+ÃÂ¦ÃÂÃÂ¹ÃÂ¥ÃÂÃÂÃÂ¯ÃÂ¼ÃÂÃÂ©ÃÂÃÂ ÃÂ¨ÃÂ¿ÃÂÃÂ©ÃÂÃÂÃÂ¥ÃÂ¤ÃÂ´ÃÂ¯ÃÂ¼ÃÂ
 *   ÃÂ¥ÃÂÃÂÃÂ¥ÃÂ¼ÃÂ§ = ellipse ÃÂ¤ÃÂ¸ÃÂÃÂ¥ÃÂÃÂÃÂ¥ÃÂÃÂÃÂ¯ÃÂ¼ÃÂy-ÃÂ¦ÃÂÃÂ¹ÃÂ¥ÃÂÃÂÃÂ¯ÃÂ¼ÃÂÃÂ§ÃÂ©ÃÂ¿ÃÂ¨ÃÂ¿ÃÂÃÂ¨ÃÂºÃÂ«ÃÂ¤ÃÂ½ÃÂÃÂ¥ÃÂÃÂÃÂ©ÃÂÃÂ¢ÃÂ¯ÃÂ¼ÃÂ
 */
export function drawEllipse(
  ...
  strokeWidth = 5.0,
  opacity = 0.92,
  bodyHalfRatio = 0.27,  // 身体半宽 / rx（肩点到中心 / 椭圆长轴半径）
) {
  ...
  // 计算翅膀角度：arccos(bodyHalfRatio)
  // bodyHalfRatio = (shoulderDist/2) / rx ≈ 0.27（肩宽占椭圆长轴约54%）
  // wingAngle ≈ 74°：在此角度处椭圆弧穿过肩膀位置
  const safeRatio = Math.min(0.98, Math.max(0.05, bodyHalfRatio));
  const wingAngle = Math.acos(safeRatio); // rad, ≈1.30 rad ≈ 74°
  ...
  // ── 2. 绘制可见弧段（前弧 + 后弧两侧翅膀）──
  // 前弧：0 → π（下半弧，朝向镜头，全显示）
  // 后弧左翅：π → π+wingAngle（延伸超出身体左侧，可见）
  // 后弧右翅：2π-wingAngle → 2π（延伸超出身体右侧，可见）
  // 隐藏段：π+wingAngle → 2π-wingAngle（穿过身体背后，不画）
  ...
  drawArcWithGlow(0, Math.PI);                          // 前弧（全）
  drawArcWithGlow(Math.PI, Math.PI + wingAngle);        // 后弧左翅
  drawArcWithGlow(2 * Math.PI - wingAngle, 2 * Math.PI); // 后弧右翅

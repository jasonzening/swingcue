/**
 * keypointOverlay.ts ÃÂ¢ÃÂÃÂ ÃÂ¦ÃÂÃÂÃÂ¨ÃÂ½ÃÂ¬ÃÂ§ÃÂÃÂÃÂ¯ÃÂ¼ÃÂÃÂ¥ÃÂ¯ÃÂ¹ÃÂ¦ÃÂ ÃÂÃÂ¦ÃÂ ÃÂ·ÃÂ¦ÃÂÃÂ¿ÃÂ¥ÃÂÃÂ¾ÃÂ¯ÃÂ¼ÃÂ
 *
 ...
 *   guide line ÃÂ¤ÃÂ»ÃÂ leftPt ÃÂ¢ÃÂÃÂ rightPt ÃÂ¦ÃÂ²ÃÂ¿ÃÂ¦ÃÂÃÂ¹ÃÂ¥ÃÂÃÂÃÂ¥ÃÂ»ÃÂ¶ÃÂ¤ÃÂ¼ÃÂ¸ÃÂ¯ÃÂ¼ÃÂÃÂ§ÃÂ»ÃÂÃÂ¨ÃÂ¿ÃÂÃÂ¤ÃÂ¸ÃÂ¤ÃÂ¤ÃÂ¸ÃÂªÃÂ§ÃÂÃÂÃÂ¥ÃÂ®ÃÂÃÂ¨ÃÂÃÂ©ÃÂ§ÃÂÃÂ¹
 ...
 *
 * guide line ÃÂ§ÃÂÃÂ»ÃÂ¦ÃÂ³ÃÂÃÂ¯ÃÂ¼ÃÂ
 *   ÃÂ¦ÃÂÃÂ¹ÃÂ¥ÃÂÃÂ = leftPt ÃÂ¢ÃÂÃÂ rightPt
 *   ÃÂ§ÃÂ«ÃÂ¯ÃÂ§ÃÂÃÂ¹ = ÃÂ¨ÃÂÃÂ©ÃÂ§ÃÂÃÂ¹ÃÂ¤ÃÂ½ÃÂÃÂ§ÃÂ½ÃÂ®ÃÂ¥ÃÂÃÂÃÂ¥ÃÂ¾ÃÂÃÂ¥ÃÂ¤ÃÂÃÂ¥ÃÂ»ÃÂ¶ÃÂ¤ÃÂ¼ÃÂ¸ extraExtÃÂ¯ÃÂ¼ÃÂÃÂ¦ÃÂ ÃÂ·ÃÂ¦ÃÂÃÂ¿ÃÂ¥ÃÂÃÂ¾ÃÂ¤ÃÂ¸ÃÂ­ÃÂ§ÃÂºÃÂ¿ÃÂ¨ÃÂ¶ÃÂÃÂ¥ÃÂÃÂºÃÂ¨ÃÂÃÂ©ÃÂ§ÃÂÃÂ¹ÃÂ¯ÃÂ¼ÃÂ
 *   ÃÂ¨ÃÂ¿ÃÂÃÂ¦ÃÂ ÃÂ·ÃÂ§ÃÂÃÂ½ÃÂ§ÃÂºÃÂ¿ÃÂ¤ÃÂ¸ÃÂÃÂ¥ÃÂ®ÃÂÃÂ§ÃÂ»ÃÂÃÂ¨ÃÂ¿ÃÂÃÂ¤ÃÂ¸ÃÂ¤ÃÂ¤ÃÂ¸ÃÂªÃÂ¨ÃÂÃÂ©ÃÂ§ÃÂÃÂ¹
 */
...
/* ÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂ
   ...
   1. cx/cy = mid(leftPt, rightPt) ÃÂ¢ÃÂÃÂ ÃÂ¤ÃÂ¸ÃÂÃÂ¤ÃÂ¸ÃÂÃÂ§ÃÂ§ÃÂ»ÃÂ¯ÃÂ¼ÃÂÃÂ¨ÃÂ®ÃÂ©guide lineÃÂ§ÃÂ»ÃÂÃÂ¨ÃÂ¿ÃÂÃÂ¨ÃÂÃÂ©ÃÂ§ÃÂÃÂ¹
   2. rx = dist * rxMult ÃÂ¢ÃÂÃÂ ÃÂ¦ÃÂ¤ÃÂ­ÃÂ¥ÃÂÃÂÃÂ©ÃÂÃÂ¿ÃÂ¨ÃÂ½ÃÂ´ÃÂ¯ÃÂ¼ÃÂÃÂ¦ÃÂ¯ÃÂÃÂ¨ÃÂÃÂ©ÃÂ¥ÃÂ®ÃÂ½ÃÂ¯ÃÂ¼ÃÂ
   3. ry = rx * ryRatio ÃÂ¢ÃÂÃÂ ÃÂ¦ÃÂ¤ÃÂ­ÃÂ¥ÃÂÃÂÃÂ§ÃÂÃÂ­ÃÂ¨ÃÂ½ÃÂ´ÃÂ¯ÃÂ¼ÃÂÃÂ¥ÃÂ¾ÃÂÃÂ¦ÃÂÃÂÃÂ¯ÃÂ¼ÃÂ
   4. guide line ÃÂ¤ÃÂ»ÃÂ leftPt ÃÂ¥ÃÂÃÂºÃÂ¥ÃÂÃÂÃÂ¯ÃÂ¼ÃÂÃÂ¦ÃÂ²ÃÂ¿ÃÂ¦ÃÂÃÂ¹ÃÂ¥ÃÂÃÂÃÂ¥ÃÂ»ÃÂ¶ÃÂ¤ÃÂ¼ÃÂ¸ extraRatio ÃÂ¨ÃÂÃÂ³ rightPt ÃÂ¥ÃÂÃÂÃÂ¥ÃÂ»ÃÂ¶ÃÂ¤ÃÂ¼ÃÂ¸
      ÃÂ¢ÃÂÃÂ ÃÂ¤ÃÂ¿ÃÂÃÂ¨ÃÂ¯ÃÂÃÂ§ÃÂ»ÃÂÃÂ¨ÃÂ¿ÃÂÃÂ¤ÃÂ¸ÃÂ¤ÃÂ¤ÃÂ¸ÃÂªÃÂ§ÃÂÃÂÃÂ¥ÃÂ®ÃÂÃÂ¥ÃÂÃÂ³ÃÂ©ÃÂÃÂ®ÃÂ§ÃÂÃÂ¹
ÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂ */
function buildDisc(
  ...
  opts: {
    ...
    ryRatio:    number;
    maxAngle:   number;
    extraRatio: number;   // guide line ÃÂ¥ÃÂÃÂ¨ÃÂ¨ÃÂÃÂ©ÃÂ§ÃÂÃÂ¹ÃÂ¥ÃÂ¤ÃÂÃÂ¥ÃÂ»ÃÂ¶ÃÂ¤ÃÂ¼ÃÂ¸ = dist * extraRatio
    label:      string;
  },
  color: AC,
  prevKey: string,
  ...
  // guide lineÃÂ¯ÃÂ¼ÃÂÃÂ¤ÃÂ»ÃÂ leftPt ÃÂ¢ÃÂÃÂ rightPt ÃÂ¦ÃÂÃÂ¹ÃÂ¥ÃÂÃÂÃÂ¯ÃÂ¼ÃÂÃÂ¤ÃÂ¸ÃÂ¤ÃÂ§ÃÂ«ÃÂ¯ÃÂ¥ÃÂÃÂÃÂ©ÃÂ¢ÃÂÃÂ¥ÃÂ¤ÃÂÃÂ¥ÃÂ»ÃÂ¶ÃÂ¤ÃÂ¼ÃÂ¸ extraRatio * dist
  // ÃÂ¨ÃÂ¿ÃÂÃÂ¦ÃÂ ÃÂ·ÃÂ§ÃÂÃÂ½ÃÂ§ÃÂºÃÂ¿ÃÂ¤ÃÂ¸ÃÂÃÂ¥ÃÂ®ÃÂÃÂ§ÃÂ»ÃÂÃÂ¨ÃÂ¿ÃÂ leftPt ÃÂ¥ÃÂÃÂ rightPt ÃÂ¤ÃÂ¸ÃÂ¤ÃÂ¤ÃÂ¸ÃÂªÃÂ§ÃÂÃÂÃÂ¥ÃÂ®ÃÂÃÂ¨ÃÂÃÂ©ÃÂ§ÃÂÃÂ¹
  const ar = smoothDeg * Math.PI / 180;
  const cosA = Math.cos(ar), sinA = Math.sin(ar);
  const extra = dist * opts.extraRatio;  // ÃÂ¨ÃÂÃÂ©ÃÂ§ÃÂÃÂ¹ÃÂ¥ÃÂ¤ÃÂÃÂ¥ÃÂ»ÃÂ¶ÃÂ¤ÃÂ¼ÃÂ¸ÃÂ©ÃÂÃÂ¿ÃÂ¥ÃÂºÃÂ¦
  // guide line ÃÂ§ÃÂ«ÃÂ¯ÃÂ§ÃÂÃÂ¹ = ÃÂ¨ÃÂÃÂ©ÃÂ§ÃÂÃÂ¹ÃÂ¤ÃÂ½ÃÂÃÂ§ÃÂ½ÃÂ® ÃÂÃÂ± extra
...
export function generateSpecDrivenOverlayFrame(
  ...
  if (ls && rs) {
    els.push(...buildDisc(ls, rs, {
      ...
      maxAngle:   viewType === 'face_on' ? 30 : 50,
      extraRatio: 0.20,  // guide line ÃÂ¥ÃÂÃÂ¨ÃÂ¨ÃÂÃÂ©ÃÂ§ÃÂÃÂ¹ÃÂ¥ÃÂ¤ÃÂÃÂ¥ÃÂ»ÃÂ¶ÃÂ¤ÃÂ¼ÃÂ¸ 20% ÃÂ¨ÃÂÃÂ©ÃÂ¥ÃÂ®ÃÂ½ÃÂ¯ÃÂ¼ÃÂÃÂ¦ÃÂ ÃÂ·ÃÂ¦ÃÂÃÂ¿ÃÂ¥ÃÂÃÂ¾ÃÂ¤ÃÂ¸ÃÂ­ÃÂ§ÃÂºÃÂ¿ÃÂ¨ÃÂ¶ÃÂÃÂ¥ÃÂÃÂºÃÂ¯ÃÂ¼ÃÂ
      label:      'SHOULDERS',
    }, 'red', 'shoulder', 'body'));
  }
  ...
  if (lh && rh) {
    els.push(...buildDisc(lh, rh, {
      ...
      maxAngle:   viewType === 'face_on' ? 25 : 45,
      extraRatio: 0.15,
      label:      'HIPS',
    }, 'red', 'hip', 'club'));
  }
...
/* ÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂ compat ÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂ */

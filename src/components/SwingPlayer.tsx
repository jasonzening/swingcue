...
const css = `
  ...
  .sp-phase-badge { display:inline-block; background:rgba(0,0,0,0.72); color:var(--text-primary); font-size:9px; font-weight:800; letter-spacing:.12em; padding:3px 9px; border-radius:100px; font-family:'DM Sans',system-ui; }
  ...
  .sp-src-real { background:rgba(255, 255, 255, 0.18); color:var(--text-primary); }
  ...
  .sp-skel-toggle { position:absolute; top:36px; right:10px; z-index:4; width:30px; height:30px; padding:0; font-size:16px; line-height:1; border-radius:50%; background:rgba(0,0,0,0.65); border:1px solid rgba(255,255,255,0.10); color:var(--text-primary); cursor:pointer; display:flex; align-items:center; justify-content:center; -webkit-tap-highlight-color:transparent; transition:transform 0.12s, background 0.12s; }
  .sp-skel-toggle:active { transform:scale(0.88); }
  .sp-skel-on { background:rgba(255, 255, 255, 0.18) !important; border-color:rgba(255, 255, 255, 0.45) !important; }
  ...
  .sp-lb-on { color:var(--text-primary) !important; background:rgba(255, 255, 255, 0.12) !important; border-color:rgba(255, 255, 255, 0.3) !important; }
  ...
  .sp-play { font-size:17px; background:var(--text-primary); color:#080c08; border:none; border-radius:50%; width:38px; height:38px; cursor:pointer; display:flex; align-items:center; justify-content:center; flex-shrink:0; -webkit-tap-highlight-color:transparent; transition:transform 0.1s; }
  ...
  .sp-spd-on { background:rgba(255, 255, 255, 0.12) !important; color:var(--text-primary) !important; border-color:rgba(255, 255, 255, 0.3) !important; }
  ...
  .sp-fill { position:absolute; left:0; top:50%; height:4px; background:var(--text-primary); border-radius:2px; transform:translateY(-50%); pointer-events:none; }
  ...
  .sp-tick { position:absolute; top:50%; width:2px; height:8px; background:rgba(255, 255, 255, 0.45); transform:translate(-50%,-50%); border-radius:1px; pointer-events:none; }
  ...
  .sp-pb-on { color:var(--text-primary) !important; background:rgba(255, 255, 255, 0.1) !important; border-color:rgba(255, 255, 255, 0.26) !important; }
`;

...
const css = `
  * { box-sizing: border-box; margin: 0; padding: 0; }
  ...
  .card {
    ...
    background: #0c130b; border: 1px solid rgba(255, 255, 255, 0.12);
    border-radius: 24px; padding: 36px 28px 32px;
    display: flex; flex-direction: column; gap: 8px;
  }
  .logo { font-size: 18px; font-weight: 800; color: var(--text-primary); letter-spacing: -0.3px; margin-bottom: 8px; }
  ...
  .reset-sent strong { color: var(--text-primary); }
